...
<head>
    <meta charset="UTF-8">
    <link rel="stylesheet" href="./UserPagesCss/AllBooks.css">
...
<div class="container">
    ...
    <ul class="nav nav-pills nav-justified">
        <li class="nav-item">
            <a class="nav-link active" href="AllBooks">All books</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="MarkedBooks">My books</a>
        </li>
        <li class="nav-item">
                ...
                <div class="product-top text-center">
                    ...
                    <div class="overlay">
                        ...
                        <button type="submit" name="ViewButton" value="${book.getIsbn()}" class="btn btn-secondary"
                            ...
                            <form method="post" action="MarkBook">
